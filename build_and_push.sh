...
#docker buildx build --platform linux/386,linux/amd64,linux/arm64,linux/arm/v6,linux/arm/v7,linux/arm/v8 --pull --rm -f "Dockerfile" -t "${target_image}:${tag_a}" "." --progress=plain --no-cache --push
